...
{{ Form::model($quiosc, array('class' => 'form-horizontal', 'method' => 'PATCH', 'route' => array('quioscs.update', $quiosc->id))) }}
...
<div class="form-group">
    ...
    <div class="col-sm-10">
      ...
      {{ link_to_route('quioscs.show', 'Cancel', $quiosc->id, array('class' => 'btn btn-lg btn-default')) }}
    </div>
</div>
